...
export function HeroSection({ scrollToSection }: HeroSectionProps) {
  ...
  return (
    <section id="home" className="relative min-h-[80vh] sm:min-h-screen flex items-center justify-center overflow-hidden pb-8 sm:pb-0 ">
      {/* Hero Background SVG */}
      ...
      <div className="relative z-10 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto w-full pt-14 sm:pt-0">
        <div className="text-center ">
          ...
          <motion.div
            ...
            className="mb-8 sm:mb-12"
          >
            <p className="text-base  text-slate-600 dark:text-slate-300 leading-relaxed max-w-3xl mx-auto">
              We craft cutting-edge software solutions that transform businesses. From AI-powered applications to 
              enterprise-grade systems, we deliver innovative technology that drives growth, efficiency, and competitive advantage.
            </p>
          </motion.div>
